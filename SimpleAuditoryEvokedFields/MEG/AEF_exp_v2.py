# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 19:44:21 2023
...
# Depending on the event value the DoutChannel is defined
TriggerValue = 1
...
audio_data = np.stack((click_left,click_right),axis=0)    
...
#--------------------------------------------------------------------------------------------------------------
dp.DPxWriteDoutBuffer(bufferData = trigger,
